...
1. A merchant wallet creates a QR stamp card.
...
- Installable app manifest with a merchant QR stamp card description, dashboard shortcut description, create QR stamp card shortcut description, and maskable icons
