...
- Installable app manifest with dashboard/create shortcut descriptions and maskable icons
...
- `/app/rewards`, `/rewards`, `/merchant/verify`, `/verify`, `/success`, and old store URLs redirect into `/app`
