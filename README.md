...
- Reward ticket QR with a print sheet and counter backup code for owner wallet validation
...
- `/app/claim/[claimId]`: reward ticket QR, print sheet, counter backup code, and owner validation
