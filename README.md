...
- Accessible app structure with named landmarks, visible focus, hover titles, progress meters, timer labels, full language names and current-language state for language controls, live regions, QR scanner feedback, and scanner busy states
