...
Use separate shop owner and customer wallets, or use separate browser profiles, so wallet-gated states stay clear during the demo. Confirm `NEXT_PUBLIC_APP_URL` matches a local, LAN, or deployed URL that phones can reach before showing QR links.
