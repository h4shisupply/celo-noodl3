...
3. Open `/app`, connect a wallet, optionally add a display name, and create a merchant QR stamp card with a square public HTTPS logo URL, reward promise, and visit goal.
...
9. Collect or issue enough stamps to reach the visit goal.
