...
3. Open `/app`, connect a wallet, optionally add a profile name, and create a QR stamp card with an HTTPS icon URL.
4. Open the manager view and show the fixed visit QR actions: copy, share, SVG download, and print sheet.
...
10. Claim the reward from the customer QR stamp card.
