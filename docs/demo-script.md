...
3. Open `/app`, connect a wallet, optionally add a display name, and create a merchant QR stamp card with a square HTTPS logo image URL, reward promise, and customer visit goal.
