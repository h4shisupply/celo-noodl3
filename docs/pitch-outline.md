...
- Generate a one-use five-minute live visit QR on localhost for desktop demos or through a secure tunnel or HTTPS preview for phone scans
...
- Validate phone QR scans through a secure tunnel or HTTPS preview, printed QR flows, and matching app URL, chain, and contract env values before each merchant demo
