...
## Slide 3
- Product
- A merchant wallet creates a merchant QR stamp card with a reward promise
...
## Slide 6
- Demo loop
- Create merchant QR stamp card with an HTTPS logo URL, reward promise, and visit goal
...
- Customer creates a reward ticket
