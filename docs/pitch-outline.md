...
- The shop owner validates each reward ticket once with the shop owner wallet and sees the used state
...
- Shop owners can issue manual stamps to customer wallets
...
- Validate phone QR scans and printed QR flows before each merchant demo
