...
- Confirm the app manifest description, icon, dashboard and create-card shortcut names and descriptions, categories, language, theme color, standalone display mode, and portrait orientation work when installed on mobile.
