...
- Confirm package metadata keywords match the Celo, MiniPay, PWA, QR, counter QR, QR stamp card, static visit QR, dynamic visit QR, live QR, reward ticket QR, wallet, and merchant reward surfaces.
