...
- Confirm customer can create a reward claim at the reward threshold.
...
- Confirm dashboard QR stamp cards, managed programs, and reward claims expose accessible names from visible card text.
