...
- Confirm root metadata keywords cover Celo, Celo loyalty, MiniPay, PWA, installable loyalty app, loyalty, loyalty program, manual stamp, merchant, shop owner wallet, customer loyalty, customer QR stamp card, merchant loyalty, merchant QR stamp card, QR, QR loyalty, QR scanner, QR SVG, counter backup code, counter QR, QR stamp card, stamp card, QR code, printed visit QR, visit QR counter sheet, static visit QR, dynamic visit QR, live visit QR, live QR, visit QR, wallet, wallet stamps, visit stamps, reward ticket, reward ticket QR, reward ticket sheet, rewards, merchant rewards, and merchant reward surfaces.
