...
- Confirm the app manifest name, short name, description, app ID, start URL, scope, icon, dashboard and create-card shortcut names, shortcut short names, shortcut descriptions, categories, language (`en`), text direction, theme color, background color, standalone display mode, minimal-ui display override, and portrait orientation are correct when installed on mobile.
