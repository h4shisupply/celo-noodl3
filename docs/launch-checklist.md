...
- Confirm a dynamic visit QR signed by the shop owner can be used once to collect one visit stamp, then fails on reuse.
...
- Confirm QR scanner live regions announce complete scanner status updates.
