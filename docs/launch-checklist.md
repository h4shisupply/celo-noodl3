...
- Confirm package metadata keywords match the Celo, MiniPay, QR, counter QR, QR stamp card, static visit QR, dynamic visit QR, live QR, reward ticket QR, wallet, and merchant reward surfaces.
