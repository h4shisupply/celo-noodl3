...
- Confirm fixed visit QR copy link, share fallback, SVG download, and print sheet actions work.
...
- Confirm owner-signed dynamic visit QR can be used once to collect one dynamic stamp, then fails on reuse.
...
- Confirm package metadata keywords match the Celo, MiniPay, PWA, customer loyalty, loyalty program, QR, counter QR, QR stamp card, static visit QR, dynamic visit QR, live QR, reward ticket, reward ticket QR, wallet, wallet stamps, and merchant reward surfaces.
- Confirm package repository, homepage, and issue links point to the public noodl3 project.
- Confirm root metadata keywords cover Celo, MiniPay, PWA, customer loyalty, counter QR, QR stamp card, QR code, static visit QR, dynamic visit QR, live QR, wallet stamps, reward ticket, reward ticket QR, and merchant rewards.
...
- Confirm app route metadata descriptions summarize the landing page, dashboard, create QR stamp card, customer QR stamp card, manager, and reward ticket pages.
