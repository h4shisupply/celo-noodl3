...
- Confirm dashboard QR stamp cards, managed QR stamp cards, and reward tickets expose accessible names from visible card text.
...
- Confirm package metadata keywords match the Celo, Celo loyalty, MiniPay, PWA, customer loyalty, customer QR stamp card, loyalty program, merchant, merchant loyalty, merchant QR stamp card, QR, QR code, counter QR, QR stamp card, stamp card, printed visit QR, static visit QR, dynamic visit QR, live QR, visit QR, reward ticket, reward ticket QR, rewards, wallet, wallet stamps, visit stamps, merchant rewards, and merchant reward surfaces.
- Confirm package repository, homepage, and issue links point to the public noodl3 project.
- Confirm root metadata keywords cover Celo, Celo loyalty, MiniPay, PWA, customer loyalty, customer QR stamp card, merchant loyalty, merchant QR stamp card, counter QR, QR stamp card, QR code, printed visit QR, static visit QR, dynamic visit QR, live QR, visit QR, wallet stamps, visit stamps, reward ticket, reward ticket QR, and merchant rewards.
