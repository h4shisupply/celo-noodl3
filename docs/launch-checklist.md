...
- Confirm custom select controls expose listbox semantics, expanded state, selected-option state, option descriptions, and clear visual states for open and closed menus.
