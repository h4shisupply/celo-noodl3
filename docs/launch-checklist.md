...
- Confirm the app manifest description, app ID, start URL, scope, icon, dashboard and create-card shortcut names, shortcut descriptions, categories, language, theme color, background color, standalone display mode, minimal-ui display override, and portrait orientation are correct when installed on mobile.
