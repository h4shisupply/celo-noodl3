...
- Confirm package metadata keywords match the Celo, MiniPay, PWA, customer loyalty, loyalty program, QR, counter QR, QR stamp card, static visit QR, dynamic visit QR, live QR, reward ticket QR, wallet, wallet stamps, and merchant reward surfaces.
