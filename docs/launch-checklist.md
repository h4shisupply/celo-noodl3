...
- Confirm Open Graph and Twitter preview metadata use `NEXT_PUBLIC_APP_URL` as their base URL and show the expected title, manual-fallback-stamps description, image, and image alt text.
