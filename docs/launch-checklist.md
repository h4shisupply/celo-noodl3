...
- Confirm root metadata keywords cover Celo, Celo loyalty, MiniPay, PWA, customer loyalty, customer QR stamp card, merchant loyalty, merchant QR stamp card, counter QR, QR stamp card, QR code, static visit QR, dynamic visit QR, live QR, wallet stamps, reward ticket, reward ticket QR, and merchant rewards.
