...
- Confirm static visit QR collects one stamp and immediate reuse fails within 20 hours.
...
- Check mobile and desktop layouts for these routes:
  ...
  - `/app/claim/[claimId]`
- Confirm camera QR scanning works over HTTPS and localhost demo URLs.
