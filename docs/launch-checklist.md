...
- Check mobile and desktop layouts for these routes:
  ...
  - `/app/claim/[claimId]`
- Confirm camera QR scanning works over HTTPS and localhost URLs.
- Confirm print output includes only the printed visit QR counter sheet or the printable reward ticket sheet.
