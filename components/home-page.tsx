  ...
  return (
    ...
    >
      ...
      <section
        ...
        aria-describedby="home-problem-description"
      >
        <div className="grid gap-8 lg:grid-cols-[0.85fr_1fr] lg:items-start">
          <SectionIntro
            ...
            descriptionId="home-problem-description"
          />
      ...
      <section
        ...
        aria-describedby="home-workflow-description"
      >
        <SectionIntro
          ...
          descriptionId="home-workflow-description"
        />
      ...
      <section
        ...
        aria-describedby="home-launch-description"
      >
        <div className="rounded-lg border border-line bg-panel/88 p-5 shadow-card backdrop-blur md:p-8">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
            <SectionIntro
              ...
              descriptionId="home-launch-description"
            />
      ...
      <section
        ...
        aria-describedby="home-final-cta-description"
      >
        <div className="stamp-pattern rounded-lg border border-line bg-panel/88 p-6 text-center shadow-card backdrop-blur md:p-10">
          ...
          <p
            id="home-final-cta-description"
            className="mx-auto mt-4 max-w-2xl text-base leading-8 text-muted"
          >
          ...
          <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <Link
              href="/app"
              title={copy.finalCta.secondaryCta}
...
function SectionIntro({
  ...
  return (
    <div className="max-w-3xl space-y-4">
      ...
      {description ? (
        <p id={descriptionId} className="text-base leading-8 text-muted">
          {description}
        </p>
      ) : null}
    </div>
...
const enHomeCopy: HomeCopy = {
  ...
  workflow: {
    ...
    steps: [
      ...
      {
        title: "Create a reward ticket",
        description: "A full card becomes a reward ticket with its own QR, reward ticket sheet, and counter backup code."
      },
      {
        title: "Validate once",
    ...
    items: [
      {
        ...
        description: "Create a branded stamp card with a shop name, logo, a reward promise, and a visit goal."
      },
      {
  ...
  proof: {
    ...
    items: [
      ...
      {
        title: "Reward ticket",
        description: "A completed card creates a reward ticket QR, reward ticket sheet, and counter backup code for validation."
      },
      {
  ...
  launch: {
    ...
    checklist: [
      ...
      "Use the live QR for shop-owner-led check-ins when needed.",
      "Let customers collect stamps at the counter.",
      "Open reward tickets with a QR, reward ticket sheet, and counter backup code.",
  ...
  faq: {
    ...
    items: [
      ...
      {
        question: "What is the difference between the printed QR and the live QR?",
        answer: "The printed QR is reusable for visit stamps once every 20 hours. The live QR is generated by the shop owner, expires in five minutes, and is best for guided check-ins."
      },
      {
        question: "How is a reward ticket protected?",
        answer: "Each reward ticket is validated once by the shop owner wallet, whether the shop owner scans the QR or uses the counter backup code. After that, the app shows it as used."
      },
      {
...
const ptHomeCopy: HomeCopy = {
  ...
  hero: {
    ...
    stats: [
      { value: "QR de visita", label: "Uma leitura no balcão para selos de visita" },
  ...
  workflow: {
    ...
    steps: [
      ...
      {
        title: "Crie o ticket",
        description: "Um cartão completo vira ticket de recompensa com QR próprio, folha de impressão e código de apoio."
      },
      {
  ...
  benefits: {
    ...
    items: [
      ...
      {
        title: "Bilíngue desde a primeira leitura",
  ...
  proof: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Cartão completo cria um QR de ticket de recompensa, folha de impressão e código de apoio para validação no balcão."
      },
      {
        title: "Validação pelo lojista",
        description: "A carteira do lojista valida o ticket de recompensa, e tickets de recompensa usados mostram um estado claro."
      }
    ]
  },
  launch: {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "Cada ticket de recompensa é validado uma vez pela carteira do lojista, seja pelo QR ou pelo código de apoio. Depois disso, o app mostra que ele já foi usado."
      },
      {
