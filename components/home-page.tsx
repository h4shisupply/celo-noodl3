...
const enHomeCopy: HomeCopy = {
  ...
  launch: {
    ...
    checklist: [
      "Create a branded stamp card with a reward promise and customer visit goal from the shop owner wallet.",
      ...
      "Open reward tickets with QR, print sheet, and backup code.",
