    ...
    items: [
      {
        ...
        description: "Create a branded stamp card with a shop name, logo, reward promise, and customer visit goal."
      },
      {
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "Printed QR is reusable for visit stamps every 20 hours. Live QR is generated by the shop owner, expires in five minutes, and is best for guided check-ins."
      },
      {
