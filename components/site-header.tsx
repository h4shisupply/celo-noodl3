  ...
  return (
    <header className="py-4 md:py-5" ref={headerRef} aria-label={dictionary.common.landingPage}>
      <div className="flex items-center justify-between gap-6">
        <BrandMark
          href={brandHref}
          ariaLabel={`${dictionary.brand.name}: ${dictionary.common.landingPage}`}
        />
        ...
        <div className="hidden items-center gap-3 md:flex">
          <nav
            ...
            aria-label={dictionary.common.landingNavigation}
          >
            {items.map((item) => (
      ...
      {menuOpen ? (
        ...
        >
          <nav className="grid gap-3" aria-label={dictionary.common.landingNavigation}>
            {items.map((item) => (
              <NavLink
