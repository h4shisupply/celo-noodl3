...
export const metadata: Metadata = {
  ...
  description:
    "Wallet QR stamp cards for real-world visits on Celo. Print a counter QR, collect visit stamps, and validate each reward ticket once.",
  ...
  openGraph: {
    title: "noodl3",
    description:
      "QR stamp cards for small shops, with counter QR scans, live check-ins, and one-time reward tickets on Celo.",
