    ...
    shortcuts: [
      {
        ...
        description: "Open the noodl3 wallet dashboard for customer and merchant QR stamp cards, visit stamps, and reward tickets.",
        url: "/app",
        icons: [
          {
            src: "/icon.svg",
      ...
      },
      {
        ...
        description: "Create a Celo-native merchant QR stamp card with a shop logo URL, reward promise, and visit goal.",
        url: "/app/program/new",
        icons: [
          {
            src: "/icon.svg",
