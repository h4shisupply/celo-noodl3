...
export const metadata: Metadata = {
  ...
  description: "Redirect legacy merchant reward verification links with a claim query to the matching Celo-native reward ticket QR page, and links without a claim query to the noodl3 dashboard."
};
