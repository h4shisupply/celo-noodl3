...
export const metadata: Metadata = {
  ...
  description: "Redirect legacy merchant reward verification links to the matching noodl3 reward ticket QR page when a claim query is present, or to the dashboard otherwise."
};
