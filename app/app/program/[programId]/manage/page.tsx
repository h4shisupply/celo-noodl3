...
export const metadata: Metadata = {
  ...
  description: "Manage a Celo-native merchant QR stamp card for shop owner wallets with printed visit QR actions, a one-use five-minute live visit QR, manual fallback stamps, customer progress, and reward tickets."
};
