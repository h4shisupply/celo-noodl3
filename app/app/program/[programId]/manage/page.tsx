...
export const metadata: Metadata = {
  ...
  description: "Manage a Celo-native merchant QR stamp card with printed visit QR actions, a five-minute live visit QR, manual stamps, customer progress, and reward tickets."
};
