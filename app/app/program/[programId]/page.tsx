...
export const metadata: Metadata = {
  ...
  description: "Collect visit stamps using printed and live visit QR links, track progress, and create a reward ticket from a Celo-native customer QR stamp card."
};
