...
export const metadata: Metadata = {
  ...
  description: "Collect visit stamps from printed and one-use five-minute live visit QR links, see manual fallback stamps, track progress, and create a reward ticket from the customer QR stamp card."
};
