...
export const metadata: Metadata = {
  ...
  description: "Show the Celo-native reward ticket QR with its printable reward ticket sheet, counter backup code, one-time shop owner wallet validation, and used state."
};
