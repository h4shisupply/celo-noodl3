...
export const metadata: Metadata = {
  ...
  description: "Display the Celo-native reward ticket QR with its reward ticket sheet, counter backup code, and one-time shop owner wallet validation guidance."
};
